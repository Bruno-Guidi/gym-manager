...
from gym_manager.core.base import Transaction, String, Currency, Balance, Client, Activity, Subscription
...
from ui.accounting.main import BalanceHistoryUI
...
if __name__ == "__main__":
    ...
    window = BalanceHistoryUI(balance_repo, acc_system)
    window.show()
