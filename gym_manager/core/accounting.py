...
from gym_manager.core.base import Payment
...
#     def register_payment(self, day: date, client: Client, activity: Activity, method: str, responsible: str) -> int:
...
#         payment = self.payment_repo.register(client, day, activity.price, method, responsible,
#                                              description=f"Cobro por la actividad '{activity.name}'")
#
