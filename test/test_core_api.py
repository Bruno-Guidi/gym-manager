...
def test_subscribe():
    ...
    # Data setup.
    client = client_repo.create(String("dummy_name"), date(2022, 2, 1), date(2022, 2, 1), String("dummy_descr"),
                                Number(""))
...
def test_subscribe_activityChargeOnce_raisesOperationalError():
    ...
    client = Client(1, String("dummy_name"), date(2022, 2, 1), date(2022, 2, 1), String("dummy_descr"))
...
def test_subscribe_invalidClients_raisesOperationalError():
    ...
    client = Client(1, String("dummy_name"), date(2022, 2, 1), date(2022, 2, 1), String("dummy_descr"))
    other = Client(2, String("dummy_name"), date(2022, 2, 1), date(2022, 2, 1), String("dummy_descr"))
...
def test_subscribe_invalidSubscriptionDate_raisesInvalidDate():
    ...
    client = Client(1, String("dummy_name"), greater, date(2022, 2, 1), String("dummy_descr"))
    activity = Activity(String("dummy_name"), Currency(0.0), String("dummy_descr"), charge_once=False, locked=True)
...
def test_ClientViewRefreshedAfterClientUpdate():
    ...
    # Creates a Client.
    client = client_repo.create(String("CliName"), date(2000, 2, 2), date(2022, 1, 1), String("Dir"), Number(""))
    first_id = client.id
...
def test_ClientViewRefreshedAfterClientCreation():
    ...
    # Creates a Client.
    client = client_repo.create(String("CliName"), date(2000, 2, 2), date(2022, 1, 1), String("Dir"), Number(1))
    first_id = client.id
    ...
    client = client_repo.create(String("OtherName"), date(2000, 2, 2), date(2022, 1, 1), String("Dir"), Number(1))
