...
class MockBookingRepo(BookingRepo):
    ...
    def all_temporal(
        ...
        to_yield = [
            TempBooking("1", client=None, is_fixed=False, when=date(2022, 7, 11), start=time(8, 0), end=time(9, 0)),
            TempBooking("1", client=None, is_fixed=False, when=date(2022, 7, 11), start=time(12, 0), end=time(13, 0)),
            TempBooking("1", client=None, is_fixed=False, when=date(2022, 7, 11), start=time(16, 0), end=time(17, 0)),
            TempBooking("1", client=None, is_fixed=False, when=date(2022, 7, 12), start=time(16, 0), end=time(17, 0)),
            TempBooking("1", client=None, is_fixed=False, when=date(2022, 7, 12), start=time(16, 0), end=time(17, 0))
        ]
...
def test_BookingSystem_blocks():
    # noinspection PyTypeChecker
    booking_system = BookingSystem(courts=(("1", Currency(0)), ("2", Currency(0))), durations=(), start=time(8, 0),
                                   end=time(12, 0), minute_step=60, activity=None, repo=MockBookingRepo())
...
def test_BookingSystem_outOfRange():
    # noinspection PyTypeChecker
    booking_system = BookingSystem(courts=(("1", Currency(0)), ("2", Currency(0))), durations=(), start=time(8, 0),
                                   end=time(23, 0), minute_step=60, activity=None, repo=MockBookingRepo())
...
def test_BookingSystem_bookingAvailable():
    ...
    # noinspection PyTypeChecker
    booking_system = BookingSystem(dummy_activity, booking_repo, courts=(("1", Currency(0)), ("2", Currency(0))),
                                   durations=(), start=time(8, 0), end=time(18, 0), minute_step=60)
